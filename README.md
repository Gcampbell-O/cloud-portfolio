...
Hands-on Azure projects built while working toward AZ-104 and SC-500, documenting the path from cloud fundamentals to cloud security engineering.
...
Each project folder has its own README with the architecture, the decisions made, and what it cost to run.
